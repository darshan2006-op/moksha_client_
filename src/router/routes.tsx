...
import { Component as RegistrationsError } from '../pages/account/RegistrationsError'
  ...
  <Route element={<FloatingWindow />}>
    <Route element={<DefaultLayout />}>
      ...
      <Route loader={getReceivedTeamInvites} element={<AccountLayout />}>
        ...
        <Route path='/account/registrations' lazy={fetchRoute(Registrations)} errorElement={<RegistrationsError />} />
